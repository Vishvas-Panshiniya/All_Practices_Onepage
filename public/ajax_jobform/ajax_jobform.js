...
async function submitform() {
    ...
    let received = await data.json();
    if (received.success === true) {
        window.location.href = "http://localhost:7095/login/dashboard/ajaxjobform"
    }
}
...
async function updateform() {
    ...
    if (updatedata.success === true) {
        window.location.href = "http://localhost:7095/login/dashboard/joblistdata"
    }
}
